...
public class Constants {
    ...
    public final static double LATITUDE = 51.519425;
    public final static double LONGITUDE = -0.169666;
    public final static String STOP_TYPE_TUBES = "NaptanMetroStation";
